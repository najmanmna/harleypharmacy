        ...
        <div className="flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
               ...
               {/* UPGRADED: The "Spotlight" Feature Grid */}
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                  <SpotlightCard className="p-6 group">
                     <Zap className="w-8 h-8 text-luxury-bronze mb-4 group-hover:scale-110 transition-transform" />
                     <h4 className="text-lg font-bold mb-2">Instant Dispensing</h4>
                     <p className="text-sm text-gray-400">Routed to pharmacy in &lt;50ms.</p>
                  </SpotlightCard>

                  <SpotlightCard className="p-6 group">
                     <Lock className="w-8 h-8 text-luxury-bronze mb-4 group-hover:scale-110 transition-transform" />
                     <h4 className="text-lg font-bold mb-2">Bank-Grade Security</h4>
                     <p className="text-sm text-gray-400">AES-256 encrypted patient data.</p>
                  </SpotlightCard>

                  <SpotlightCard className="p-6 group">
                     <Globe className="w-8 h-8 text-luxury-bronze mb-4 group-hover:scale-110 transition-transform" />
                     <h4 className="text-lg font-bold mb-2">Nationwide Logistics</h4>
                     <p className="text-sm text-gray-400">Next-day dispatch to 99% of UK.</p>
                  </SpotlightCard>

                  <SpotlightCard className="p-6 group">
                     <ShieldCheck className="w-8 h-8 text-luxury-bronze mb-4 group-hover:scale-110 transition-transform" />
                     <h4 className="text-lg font-bold mb-2">Compliance Engine</h4>
                     <p className="text-sm text-gray-400">Real-time GPhC & CQC checks.</p>
                  </SpotlightCard>
               </div>
               ...
               <button 
                ...
                className="bg-white text-deep-charcoal px-8 py-4 rounded-full font-bold hover:bg-gray-200 transition-all flex items-center gap-3 group shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]"
               >
          ...
          <div className="w-full lg:w-1/2 perspective-1000">
             ...
             >
                <SpotlightCard spotlightColor="rgba(255, 255, 255, 0.08)" className="shadow-2xl shadow-black/50">
                   ...
                   <div className="p-8 space-y-6">
                      <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                             <div className="text-gray-400 text-xs uppercase tracking-wider mb-1">Avg. Time</div>
